        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          <div>
            ...
            <ul className="space-y-2 font-body text-sm">
              ...
              <li><Link href="/pre-approval" className="hover:text-[var(--color-text-primary)]">Pre-approval</Link></li>
              <li><Link href="/dashboard" className="hover:text-[var(--color-text-primary)]">Buyer guide</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="mb-3 font-body text-xs font-semibold uppercase tracking-wider text-[var(--color-text-primary)]">
            ...
            <ul className="space-y-2 font-body text-sm">
              <li><Link href="/sell" className="hover:text-[var(--color-text-primary)]">List your home</Link></li>
              <li><Link href="/sell/dashboard" className="hover:text-[var(--color-text-primary)]">Seller dashboard</Link></li>
              <li><Link href="/#savings" className="hover:text-[var(--color-text-primary)]">Pricing</Link></li>
            </ul>
          </div>
        </div>
      </div>
